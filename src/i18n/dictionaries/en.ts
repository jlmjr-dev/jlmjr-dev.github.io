...
export const en: Dictionary = {
  ...
  game: {
    ...
    skip: "or just scroll like a normal person",
    hint: "Steer with arrow keys or WASD, swipe on touch. Eat my portfolio, one piece at a time.",
    eaten: "eaten",
    exit: "Exit game",
    gameOver: "Game over",
    continueGame: "Continue",
    win: "You win!",
    winSub: "You ate my entire portfolio. Thanks for playing; here is the takeaway version.",
