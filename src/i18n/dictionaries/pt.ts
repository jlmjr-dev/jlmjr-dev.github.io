...
export const pt: Dictionary = {
  ...
  projects: {
    heading: "Projetos",
    intro: "Coisas que construo no meu tempo livre.",
    viewCode: "Ver código",
  ...
  game: {
    ...
    skip: "ou só role a página como uma pessoa normal",
    hint: "Controle com as setas ou WASD, deslize no toque. Coma meu portfólio, um pedaço de cada vez.",
    eaten: "comido",
    exit: "Sair do jogo",
    gameOver: "Fim de jogo",
    continueGame: "Continuar",
    win: "Você venceu!",
    winSub: "Você comeu meu portfólio inteiro. Valeu por jogar; aqui vai a versão para levar.",
