...
export const pt: Dictionary = {
  ...
  game: {
    ...
    skip: "Pular o jogo e só rolar a página",
    hint: "Setas ou WASD. Deslize o dedo no toque.",
    unlocked: "desbloqueado",
    gameOver: "Fim de jogo",
    continueGame: "Continuar",
    keepPlaying: "Continuar jogando",
    jumpTo: "Ir para a seção",
    win: "Você venceu!",
    winSub: "Perfil completo desbloqueado. Valeu por jogar!",
